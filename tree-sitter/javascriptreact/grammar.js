...
module.exports = grammar({
  ...
  rules: {
    ...
    jsxelement: $ => choice(seq("<", $.jsxtag_name, repeat($.jsxattr), $.jsxself_close), seq("<", $.jsxtag_name, repeat($.jsxattr), ">", repeat($.jsxchild), $.jsxclose, optional($.jsxtag_name), ">"), seq("<", ">", repeat($.jsxchild), $.jsxclose, ">")),
