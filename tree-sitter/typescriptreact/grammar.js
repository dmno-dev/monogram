...
module.exports = grammar({
  ...
  rules: {
    ...
    decorator_expr: $ => seq($.decorator, repeat(choice(seq("(", optional(seq($.expr, repeat(seq(",", $.expr)), optional(","))), ")"), seq("<", optional(seq($.type, repeat(seq(",", $.type)), optional(","))), ">", "(", optional(seq($.expr, repeat(seq(",", $.expr)), optional(","))), ")"), "!", seq(".", choice($.ident, $.private_field))))),
    ...
    expr: $ => choice(
      ...
      $.binary_number,
      $.big_int,
      seq(optional("async"), "function", optional("*"), optional($.ident), optional($.type_params), "(", optional(seq($.param, repeat(seq(",", $.param)), optional(","))), ")", optional(seq(":", $.type)), $.block),
      seq(repeat($.decorator_expr), "class", field('name', $.ident), optional($.type_params), optional(seq("extends", $.class_heritage)), optional(seq("implements", optional(seq($.type, repeat(seq(",", $.type)), optional(","))))), "{", repeat($.class_member), "}"),
      seq(repeat($.decorator_expr), "class", optional($.type_params), optional(seq("extends", $.class_heritage)), optional(seq("implements", optional(seq($.type, repeat(seq(",", $.type)), optional(","))))), "{", repeat($.class_member), "}")
    ),
