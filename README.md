...
_Each hand-written **official** grammar vs Monogram's **derived** one, on the bugs filed against it: **TypeScript 20/22** (official 7/22) · **HTML 11/12** (official 9/12) · **Vue 12/12** (official 11/12). Per-issue detail below — auto-generated by `npm run bench:issues`._
