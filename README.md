...
The same question, every language at once: take the bugs reported against each *hand-written* official grammar and ask whether the *derived* grammar solves them. Which bugs does **only** the official solve, and which does **only** Monogram solve?
...
| language | vs hand-written grammar | Monogram | official | only Monogram | only official |
|---|---|:--:|:--:|:--:|:--:|
| TypeScript | microsoft/TypeScript-TmLanguage | **64/74** | 32/74 | 32 | 0 |
| HTML | VS Code's html.tmLanguage | **8/8** | 7/8 | 1 | 0 |
| Vue | vuejs/language-tools vue.tmLanguage.json | **11/12** | 11/12 | 0 | 0 |
